...
<div class="col-lg-12 bordered" style="padding-bottom: 5px;">
    <div class="portlet light" style="padding: 0px"> 
        ...
        <div class="media-body">
            ...
            <?php if ($PCCPKU > 1 && $PCPFRC <> 'P' && $PCPFRA <> 'Y') { ?>
                <div class="col-sm-12" style="padding-bottom: 5px;"><i class="fa fa-arrow-right"></i> Check PFR Setting: <?php echo 'Corp: ' . $PCPFRC . ' | DC: ' . $PCPFRA; ?> </div> 
                <?php
                $settingscount += 1; //add to settings count
            }
            ?>
