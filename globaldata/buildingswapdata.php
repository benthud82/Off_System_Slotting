...
switch ($var_report) {  //build sql statement for report
    case 1:
        ...
        $reportsql = " OPT_BUILDING = 1";
        $reporthaving = " OPT_CURBUILDING = 2";
        $orderby = '  A.AVG_DAILY_PICK ASC';
        break;

    case 2:
        $reportsql = " OPT_BUILDING = 2";
        $reporthaving = " OPT_CURBUILDING = 1";
        $orderby = ' A.AVG_DAILY_PICK DESC';
        break;
}
...
$bayreport = $conn1->prepare("SELECT DISTINCT
                            ...
                            FROM
                                ...
                                slotting.dsl2locs ON dsl2whs = A.WAREHOUSE
                                    ...
                                    LEFT JOIN
                                slotting.case_floor_locs F ON A.CUR_LOCATION = F.LOCATION
