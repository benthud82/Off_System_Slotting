...
$result1 = $conn1->prepare("SELECT 
                            ...
                            FROM
                                slotting.slottingscore_hist
                            WHERE
                                slottingscore_hist_WHSE = $var_whse;");
$result1->execute();
...
foreach ($result1 as $row) {
    ...
    $rows2['data'][] = $row['slottingscore_hist_LSE100'] * 1;  //Loose Score Bottom 100
    $rows1['data'][] = ($row['slottingscore_hist_LSE1000']) * 1; //Loose Score Bottom 1000
