        ...
        $bayreport = $conn1->prepare("SELECT DISTINCT
                                    ...
                                    FROM
                                        slotting.my_npfmvc A
                                            JOIN
                                        slotting.mysql_npflsm ON WAREHOUSE = LMWHSE
                                            AND ITEM_NUMBER = LMITEM
                                            AND PACKAGE_UNIT = LMPKGU
                                            LEFT JOIN
                                        slotting.minmaxreview ON minmax_item = ITEM_NUMBER
                                            AND minmax_location = CUR_LOCATION
                                    LEFT JOIN slotting.slotting_itemcomments on WAREHOUSE = itemcomments_whse and itemcomments_item = ITEM_NUMBER
                                   LEFT JOIN
                                slotting.item_settings S on S.WHSE = A.WAREHOUSE 
                                    ...
                                    WHERE
                                        WAREHOUSE = $var_whse AND SUGGESTED_MAX > CURMAX
                                            and CURMAX < CURTF
