...
$itemsettings_loose = $conn1->prepare("SELECT 
                                                                        ...
                                                                        FROM
                                                                            slotting.npfcpcsettings
                                                                                LEFT JOIN
                                                                            item_settings ON CPCWHSE = WHSE AND ITEM = CPCITEM
                                                                        WHERE
                                                                            CPCWHSE = $var_whse AND CPCITEM = $var_item;");
                ...
                <div class="list-group">
                    <div class="row">
                        <div class="col-md-6 bordered">
                            ...
                            <div class="list-group-item"> 
                                <span class="pull-right"><strong><?php echo $itemsettingsarray_loose[$key]['CPCORSH'] ?></strong></span> 
                                Shelf Orientation
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="list-group-item"> 
                                <span class="pull-right"><strong><?php echo $itemsettingsarray_loose[$key]['CPCPFRC'] ?></strong></span> 
                                Corp PFR
                            </div>
                            <div class="list-group-item"> 
                                <span class="pull-right"><strong><?php echo $itemsettingsarray_loose[$key]['CPCPFRA'] ?></strong></span> 
                                Local PFR
                            </div>
                            <div class="list-group-item"> 
...
//pull in item comments from mysql
    $itemcommentssql = $conn1->prepare("SELECT 
                                        *
                                    FROM
                                        slotting.slotting_itemcomments
                                    JOIN slotting.slottingdb_users on idslottingDB_users_ID = itemcomments_tsm
                                    WHERE
