...
$itemdetail_loose = $conn1->prepare("SELECT DISTINCT
                                ...
                                FROM
                                    ...
                                    slotting.slottingscore E ON E.SCORE_WHSE = A.WAREHOUSE
                                        ...
                                        JOIN
                                    slotting.itemdesignation F ON F.WHSE = A.WAREHOUSE
                                        AND F.ITEM = A.ITEM_NUMBER
                                WHERE
                                    ITEM_NUMBER = '$var_item'
                                    and PACKAGE_TYPE not in ('CSE','PFR')
                                    and C.LMSLR not in (2,4)
...
$itemdetail_case = $conn1->prepare("SELECT DISTINCT
                            ...
                            FROM
                                ...
                                slotting.slottingscore E ON E.SCORE_WHSE = A.WAREHOUSE
                                    ...
                                    AND E.SCORE_ZONE = A.PACKAGE_TYPE
                                    left join
                                slotting.case_floor_locs L ON L.LOCATION = A.CUR_LOCATION
