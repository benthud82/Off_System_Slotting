...
$sqldelete = "TRUNCATE TABLE slotting.smallcase_temp";
...
$smallcasetempsql = $aseriesconn->prepare("SELECT LMITEM, 
                                                                             ...
                                                                             WHERE  PCWHSE = 0 and LMWHSE = $var_whse and LMTIER in ('L02','L04','L06') and PCCPKU = 1 and PCCVOL >= 7000");
...
do {
    ...
    $sql = "INSERT IGNORE INTO slotting.smallcase_temp ($columns) VALUES $values";
...
$casepkgusql = $conn1->prepare("SELECT 
                                                                ...
                                                                END AS COMMENTS
                                                            FROM
                                                                slotting.smallcase_temp
                                                                    LEFT JOIN
                                                                slotting.caseipreview ON caseip_item = sc_item
                                                                    AND caseip_whse = sc_whse
                                                                    LEFT JOIN
                                                                slotting.slotting_itemcomments ON sc_whse = itemcomments_whse
