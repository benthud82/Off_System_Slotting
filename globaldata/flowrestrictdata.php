...
$casepkgusql = $conn1->prepare("SELECT 
                                                               ...
                                                               CONCAT(caseip_reviewdate, ' | ', caseip_tsmid) AS caseip_reviewdate,
                                                                ...
                                                                END AS COMMENTS
                                                            FROM
                                                                slotting.items_restricted
                                                                    JOIN
                                                                slotting.my_npfmvc ON REST_WHSE = WAREHOUSE
                                                                    AND REST_ITEM = ITEM_NUMBER
                                                                    AND PACKAGE_TYPE = 'LSE'
                                                               LEFT JOIN
                                                                slotting.caseipreview ON caseip_item = REST_ITEM
                                                                    AND caseip_whse = REST_WHSE
                                                                    LEFT JOIN
                                                                slotting.slotting_itemcomments ON REST_WHSE = itemcomments_whse
