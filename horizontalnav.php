...
<header id="header" class="navbar"   style="border-radius: 0px;position: fixed; width: 100%; top: 0; z-index: 1030;">
    <?php if (isset($_SESSION['MYUSER'])) { ?>
        <?php
        if (strtoupper($_SESSION['MYUSER']) === 'BHUD01' || strtoupper($_SESSION['MYUSER']) === 'JMOO07' || strtoupper($_SESSION['MYUSER']) === 'DMCKEE' || strtoupper($_SESSION['MYUSER']) === 'AJON01' || strtoupper($_SESSION['MYUSER']) === 'AROB01'||strtoupper($_SESSION['MYUSER']) === 'WHILL'||strtoupper($_SESSION['MYUSER']) === 'BROEBU'){
    ...
    <div class="pull-left btn btn-sm btn-inverse" style="margin:10px 30px 0px 10px; padding: 6px 10px;"><a href="../printvis/dashboard.php" style="color: white">Switch to: PRINT VISIBILITY DASHBOARD</a></div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="list-group list-normal m-t-n-xmini " style="max-width:275px; padding-left: 20px;"> 
                            ...
                            <a id="12"  class="list-group-item bg chngewhseclick" style="cursor: pointer"><strong>Whse 12: Vancouver</strong></a> 
                        </div>
                    </div>
                </div>
