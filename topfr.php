...
<html>
    ...
    <body style="background-color: #FFFFFF;">
        <div class="main padder" style="margin-top: 75px;padding-left: 100px; "> 
            <h2 style="padding-bottom: 0px;">Move To PFR</h2>
            ...
            <script>
                ...
                function gettable() {
                    ...
                    oTable = $('#ptbtable').dataTable({
                        ...
                        'sAjaxSource': "globaldata/data_topfr.php?userid=" + userid,
                        buttons: [
                            'copyHtml5',
                            'excelHtml5'
                        ]
                ...
                $(document).on("click", "#addreview", function (event) {
                    ...
                    $.ajax({
                        url: 'formpost/postmarkreviewed_topfr.php',
                        type: 'POST',
                        data: formData,
