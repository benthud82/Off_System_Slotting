...
$sql = "UPDATE slotting.slottingdb_itemactions SET openactions_completedcomment= '$var_commentmodal', openactions_completeduser = '$var_userid', openactions_status = 'COMPLETED', openactions_completeddate = '$datetime' WHERE openactions_id = $var_assigntask_id;";
